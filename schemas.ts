...
export const CreateGroupSchema = z.object({
  ...
  parent_id: z.coerce.string().optional().describe("The parent group ID for creating a subgroup"),
});
...
export const GitLabGroupSchema = z.object({
  ...
  auto_devops_enabled: z.boolean().optional(),
  subgroup_creation_level: z.string().optional(),
  emails_disabled: z.boolean().optional(),
  mentions_disabled: z.boolean().optional(),
